...
namespace BEPUphysics.Paths
{
    ...
    /// </summary>
    public class LinearInterpolationCurve3D : Curve<FixedV3>
    {
        /// <summary>
        ...
        {
            value = FixedV3.Lerp(ControlPoints[controlPointIndex].Value, ControlPoints[controlPointIndex + 1].Value, weight);
        }
