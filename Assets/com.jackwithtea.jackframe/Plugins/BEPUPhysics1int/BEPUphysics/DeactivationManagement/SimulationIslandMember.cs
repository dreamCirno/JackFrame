...
namespace BEPUphysics.DeactivationManagement
{
    ...
    public class SimulationIslandMember
    {
        ...
        Entity owner;
		Fixed64 previousVelocity;
        internal Fixed64 velocityTimeBelowLimit;
        ...
        public void UpdateDeactivationCandidacy(Fixed64 dt)
        {
            //Get total velocity, and see if the entity is losing energy.
            Fixed64 velocity = owner.linearVelocity.LengthSquared() + owner.angularVelocity.LengthSquared();
