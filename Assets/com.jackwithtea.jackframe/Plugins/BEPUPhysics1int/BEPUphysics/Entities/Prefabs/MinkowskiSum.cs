...
namespace BEPUphysics.Entities.Prefabs
{
    ...
    public class MinkowskiSum : Entity<ConvexCollidable<MinkowskiSumShape>>
    {
        ...
        private MinkowskiSum(OrientedConvexShapeEntry a, OrientedConvexShapeEntry b, Fixed64 m)
        ...
        /// <param name="b">Second entity in the sum.</param>
        /// <param name="mass">Mass of the object.</param>
        public MinkowskiSum(MotionState motionState, OrientedConvexShapeEntry a, OrientedConvexShapeEntry b, Fixed64 mass)
            : this(a, b, mass)
        {
        ...
        /// <param name="mass">Mass of the object.</param>
        public MinkowskiSum(MotionState motionState, IList<OrientedConvexShapeEntry> shapes, Fixed64 mass)
