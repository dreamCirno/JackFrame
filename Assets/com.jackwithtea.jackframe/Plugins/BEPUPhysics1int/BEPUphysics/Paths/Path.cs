...
namespace BEPUPhysics1int.Paths
{
    ...
    public abstract class Path<TValue>
    {
        ...
        public abstract void Evaluate(Fixed64 time, out TValue value);
        ...
        public abstract void GetPathBoundsInformation(out Fixed64 startingTime, out Fixed64 endingTime);
        ...
        public TValue Evaluate(Fixed64 time)
        {
            TValue toReturn;
