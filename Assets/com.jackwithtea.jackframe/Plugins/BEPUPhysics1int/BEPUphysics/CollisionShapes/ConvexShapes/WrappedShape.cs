...
namespace BEPUphysics.CollisionShapes.ConvexShapes
{
    ...
    public class WrappedShape : ConvexShape
    {
        ...
        public Fixed64 ComputeMaximumRadius()
        {
            ...
            Fixed64 maxRadius = F64.C0;
            for (int i = 0; i < shapes.Count; i++)
            {
                Fixed64 radius = shapes.WrappedList.Elements[i].CollisionShape.MaximumRadius +
        ...
        public Fixed64 ComputeMinimumRadius()
        {
            //Could also use the tetrahedron approximation approach.
            Fixed64 minRadius = F64.C0;
            for (int i = 0; i < shapes.Count; i++)
            {
                Fixed64 radius = shapes.WrappedList.Elements[i].CollisionShape.MinimumRadius;
                if (radius < minRadius)
                    minRadius = radius;
            }
