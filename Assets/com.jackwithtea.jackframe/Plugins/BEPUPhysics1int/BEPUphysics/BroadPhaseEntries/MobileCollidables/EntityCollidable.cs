...
namespace BEPUphysics.BroadPhaseEntries.MobileCollidables
{
    ...
    public abstract class EntityCollidable : MobileCollidable
    {
        ...
        public override void UpdateBoundingBox(Fixed64 dt)
        {
        ...
        public void UpdateBoundingBoxForTransform(ref RigidTransform transform, Fixed64 dt)
        {
        ...
        protected internal abstract void UpdateBoundingBoxInternal(Fixed64 dt);

        //Helper method for mobile collidables.
        internal void ExpandBoundingBox(ref BoundingBox boundingBox, Fixed64 dt)
        {
            ...
            if (dt > F64.C0)
            {
                ...
                Fixed64 velocityScaling = useExtraExpansion ? 2 : 1;
                ...
                if (useExtraExpansion)
                {
                    ...
                    foreach (var e in OverlappedEntities)
                    {
                        ...
                        Fixed64 velocity = e.linearVelocity.LengthSquared();
                        if (velocity > expansion)
                            expansion = velocity;
                    }
                    expansion = Fixed64.Sqrt(expansion) * dt;
