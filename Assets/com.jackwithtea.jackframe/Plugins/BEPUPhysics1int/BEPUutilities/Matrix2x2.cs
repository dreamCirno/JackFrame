...
namespace BEPUutilities
{
    ...
    public struct Matrix2x2
    {
        ...
        public static void Invert(ref Matrix2x2 matrix, out Matrix2x2 result)
        {
            ...
            Fixed64 m12 = -matrix.M12 * determinantInverse;

            Fixed64 m21 = -matrix.M21 * determinantInverse;
            Fixed64 m22 = matrix.M11 * determinantInverse;
        ...
        public static void Multiply(ref Matrix2x2 a, ref Matrix2x2 b, out Matrix2x2 result)
        {
            ...
            Fixed64 resultM21 = a.M21 * b.M11 + a.M22 * b.M21;
            Fixed64 resultM22 = a.M21 * b.M12 + a.M22 * b.M22;
