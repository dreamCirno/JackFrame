...
namespace BEPUphysics.Settings
{
    ...
    public static class CollisionResponseSettings
    {
        ...
        /// Defaults to 1.
        /// </summary>
        public static Fixed64 BouncinessVelocityThreshold = F64.C1;

        /// <summary>
        /// Maximum speed at which interpenetrating objects will attempt to undo any overlap.
        /// Defaults to 2.
        /// </summary>
        public static Fixed64 MaximumPenetrationRecoverySpeed = F64.C2;

        /// <summary>
        /// Fraction of position error to convert into corrective momentum.
        /// Defaults to 0.2.
        /// </summary>
        public static Fixed64 PenetrationRecoveryStiffness = (Fixed64)0.2m;
        ...
        /// Defaults to 0.2.
        /// </summary>
        public static Fixed64 StaticFrictionVelocityThreshold = (Fixed64)0.2m;

        /// <summary>
        /// Value by which a collision pair's friction coefficient will be multiplied to get the twist friction coefficient.
        /// Defaults to 1.
        /// </summary>
        public static Fixed64 TwistFrictionFactor = (Fixed64)1m;
        ...
        /// </summary>
        public static Fixed64 Softness = (Fixed64).001m;
