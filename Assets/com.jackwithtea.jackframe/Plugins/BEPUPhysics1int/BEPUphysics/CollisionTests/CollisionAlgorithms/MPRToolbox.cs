...
namespace BEPUphysics.CollisionTests.CollisionAlgorithms
{
    ...
    public static class MPRToolbox
    {
        ...
        private static Fixed64 surfaceEpsilon = (Fixed64)1e-7m;
        /// <summary>
        /// Gets or sets how close surface-finding based MPR methods have to get before exiting.
        /// Defaults to 1e-7.
        /// </summary>
        public static Fixed64 SurfaceEpsilon
        {
            get
            {
        ...
        private static Fixed64 depthRefinementEpsilon = (Fixed64)1e-4m;
        /// <summary>
        ...
        /// Defaults to 1e-4.
        /// </summary>
        public static Fixed64 DepthRefinementEpsilon
        {
            get
            {
        ...
        private static Fixed64 rayCastSurfaceEpsilon = (Fixed64)1e-9m;
        /// <summary>
        /// Gets or sets how close surface-finding ray casts have to get before exiting.
        /// Defaults to 1e-9.
        /// </summary>
        public static Fixed64 RayCastSurfaceEpsilon
        {
            get
            {
        ...
        public static bool GetOverlapPosition(ConvexShape shapeA, ConvexShape shapeB, ref RigidTransform transformA, ref RigidTransform transformB, out FixedV3 position)
        {
        ...
        /// <returns>Whether or not the two shapes overlap.</returns>
        public static bool GetLocalOverlapPosition(ConvexShape shapeA, ConvexShape shapeB, ref RigidTransform localTransformB, out FixedV3 position)
        {
            return GetLocalOverlapPosition(shapeA, shapeB, ref localTransformB.Position, ref localTransformB, out position);
        }

        internal static bool GetLocalOverlapPosition(ConvexShape shapeA, ConvexShape shapeB, ref FixedV3 originRay, ref RigidTransform localTransformB, out FixedV3 position)
        {
            ...
            FixedV3 v0;
            FixedV3.Negate(ref originRay, out v0); //Since we're in A's local space, A-B is just -B.
            ...
            FixedV3 n = originRay;
            FixedV3 v1;
            FixedV3 v1A, v1B; //extreme point contributions from each shape.  Used later to compute contact position; could be used to cache simplex too.
            ...
            FixedV3 v2;
            FixedV3 v2A, v2B;
            FixedV3.Cross(ref v1, ref v0, out n);
            if (n.LengthSquared() < Toolbox.Epsilon)
            {
                ...
                Fixed64 dot;
                FixedV3.Dot(ref v1, ref originRay, out dot);
                if (dot < F64.C0)
                {
                    //Origin is outside.
                    position = new FixedV3();
                ...
                FixedV3.Dot(ref v0, ref originRay, out dotv0);
                Fixed64 barycentricCoordinate = -dotv0 / (dot - dotv0);
                //Vector3.Subtract(ref v1A, ref v0A, out offset); //'v0a' is just the zero vector, so there's no need to calculate the offset.
                FixedV3.Multiply(ref v1A, barycentricCoordinate, out position);
                return true;
            }
            ...
            FixedV3.Subtract(ref v1, ref v0, out temp1);
            FixedV3.Subtract(ref v2, ref v0, out temp2);
            FixedV3.Cross(ref temp1, ref temp2, out n);
            ...
            while (true)
            {
                ...
                FixedV3.Cross(ref v1, ref v3, out temp1);
                Fixed64 dot;
                FixedV3.Dot(ref temp1, ref v0, out dot);
                if (dot < F64.C0)
                {
                ...
                if (dot < F64.C0)
                {
                    ...
                    v1B = v3B;
                    // Calculate the normal of the plane that will be used to find a new extreme point.
                    FixedV3.Subtract(ref v2, ref v0, out temp1);
                    FixedV3.Subtract(ref v3, ref v0, out temp2);
                    FixedV3.Cross(ref temp1, ref temp2, out n);
                    continue;
                }
            ...
            while (true)
            {
                ...
                FixedV3.Subtract(ref v3, ref v2, out temp1);
                FixedV3.Subtract(ref v1, ref v2, out temp2);
                FixedV3.Cross(ref temp1, ref temp2, out n);
                Fixed64 dot;
                FixedV3.Dot(ref n, ref v1, out dot);
                if (dot >= F64.C0)
                {
                    FixedV3 temp3;
                    ...
                    FixedV3.Subtract(ref v1, ref v0, out temp1);
                    FixedV3.Subtract(ref v2, ref v0, out temp2);
                    FixedV3.Subtract(ref v3, ref v0, out temp3);

                    FixedV3 cross;
                    FixedV3.Cross(ref temp1, ref temp2, out cross);
                    Fixed64 v0v1v2v3volume;
                    FixedV3.Dot(ref cross, ref temp3, out v0v1v2v3volume);

                    FixedV3.Cross(ref v1, ref v2, out cross);
                    Fixed64 ov1v2v3volume;
                    FixedV3.Dot(ref cross, ref v3, out ov1v2v3volume);

                    FixedV3.Cross(ref originRay, ref temp2, out cross);
                    Fixed64 v0ov2v3volume;
                    FixedV3.Dot(ref cross, ref temp3, out v0ov2v3volume);

                    FixedV3.Cross(ref temp1, ref originRay, out cross);
                    Fixed64 v0v1ov3volume;
                    FixedV3.Dot(ref cross, ref temp3, out v0v1ov3volume);

                    if (v0v1v2v3volume > Toolbox.Epsilon * F64.C0p01)
                    {
                        Fixed64 inverseTotalVolume = F64.C1 / v0v1v2v3volume;
                        Fixed64 v0Weight = ov1v2v3volume * inverseTotalVolume;
                        Fixed64 v1Weight = v0ov2v3volume * inverseTotalVolume;
                        Fixed64 v2Weight = v0v1ov3volume * inverseTotalVolume;
                        Fixed64 v3Weight = F64.C1 - v0Weight - v1Weight - v2Weight;
                ...
                Fixed64 dot2;
                FixedV3.Dot(ref v4, ref n, out dot2);
                if (dot2 < F64.C0)
                {
                ...
                FixedV3.Cross(ref v4, ref v0, out temp1);
                FixedV3.Dot(ref v1, ref temp1, out dot);
                if (dot >= F64.C0)
                {
                    FixedV3.Dot(ref v2, ref temp1, out dot);
                    if (dot >= F64.C0)
                    {
                ...
                {
                    FixedV3.Dot(ref v3, ref temp1, out dot);
                    if (dot >= F64.C0)
                    {
        ...
        /// <param name="localTransformB">Relative transform of shape B to shape A.</param>
        /// <returns>Whether or not the shapes are overlapping.</returns>
        internal static bool AreLocalShapesOverlapping(ConvexShape shapeA, ConvexShape shapeB, ref FixedV3 originRay, ref RigidTransform localTransformB)
        {
            //Compute the origin ray.  This points from a point known to be inside the minkowski sum to the origin.
            //The centers of the shapes are used to create the interior point.
        ...
        public static void LocalSurfaceCast(ConvexShape shapeA, ConvexShape shapeB, ref RigidTransform localTransformB, ref FixedV3 direction, out Fixed64 t, out FixedV3 normal)
        {
            ...
            //Find another extreme point in a direction perpendicular to the previous.
            FixedV3 v2;
            FixedV3.Cross(ref direction, ref v1, out n);
            if (n.LengthSquared() < Toolbox.Epsilon)
            {
                //v1 and v0 could be parallel.
                //This isn't a bad thing- it means the direction is exactly aligned with the extreme point offset.
                ...
                Fixed64 rayLengthSquared = direction.LengthSquared();
                if (rayLengthSquared > Toolbox.Epsilon * F64.C0p01)
                    FixedV3.Divide(ref direction, Fixed64.Sqrt(rayLengthSquared), out normal);
                else
                    normal = new FixedV3();

                Fixed64 rate;
                FixedV3.Dot(ref  normal, ref direction, out rate);
                Fixed64 distance;
                FixedV3.Dot(ref  normal, ref v1, out distance);
                if (rate > F64.C0)
                    t = distance / rate;
                else
                    t = F64.C0;
            ...
            FixedV3 temp1, temp2;
            //Set n for the first iteration.
            FixedV3.Cross(ref v1, ref v2, out n);
            ...
            while (true)
            {
                ...
                FixedV3.Cross(ref v1, ref v3, out temp1);
                FixedV3.Dot(ref temp1, ref direction, out dot);
                if (dot < F64.C0)
                {
                    //Replace the point that was on the inside of the plane (v2) with the new extreme point.
                    v2 = v3;
                    // Calculate the normal of the plane that will be used to find a new extreme point.
                    FixedV3.Cross(ref v1, ref v3, out n);
                    continue;
                }
                ...
                if (dot < F64.C0)
                {
                    ...
                    v1 = v3;
                    // Calculate the normal of the plane that will be used to find a new extreme point.
                    FixedV3.Cross(ref v2, ref v3, out n);
                    continue;
                }
                break;
            }
            ...
            {
                //Compute the outward facing normal.
                FixedV3.Subtract(ref v1, ref v2, out temp1);
                FixedV3.Subtract(ref v3, ref v2, out temp2);
                FixedV3.Cross(ref temp1, ref temp2, out n);
                ...
                FixedV3.Dot(ref n, ref v1, out dot);
                Fixed64 supportDot;
                FixedV3.Dot(ref v4, ref n, out supportDot);
                ...
                if (supportDot - dot < surfaceEpsilon || count > MPRToolbox.InnerIterationLimit) // TODO: Could use a dynamic epsilon for possibly better behavior.
                {
                    ...
                    Fixed64 lengthSquared = n.LengthSquared();
                    if (lengthSquared > Toolbox.Epsilon * F64.C0p01)
                    {
                        FixedV3.Divide(ref n, Fixed64.Sqrt(lengthSquared), out normal);

                        //The plane is very close to the surface, and the ray is known to pass through it.
                        //dot is the rate.
                        FixedV3.Dot(ref normal, ref direction, out dot);
                        //supportDot is the distance to the plane.
                        FixedV3.Dot(ref normal, ref v1, out supportDot);
                        if (dot > F64.C0)
                            t = supportDot / dot;
                        else
                            t = F64.C0;
                ...
                FixedV3.Cross(ref v4, ref direction, out temp1);
                FixedV3.Dot(ref v1, ref temp1, out dot);
                if (dot >= F64.C0)
                {
                    FixedV3.Dot(ref v2, ref temp1, out dot);
        ...
        public static void LocalSurfaceCast(ConvexShape shapeA, ConvexShape shapeB, ref RigidTransform localTransformB, ref FixedV3 direction, out Fixed64 t, out FixedV3 normal, out FixedV3 position)
        {
            // Local surface cast is very similar to regular MPR.  However, instead of starting at an interior point and targeting the origin,
            // the ray starts at the origin (a point known to be in both shape and shapeB), and just goes towards the direction until the surface
            // is found.  The portal (v1, v2, v3) at termination defines the surface normal, and the distance from the origin to the portal along the direction is used as the 't' result.
            ...
            while (true)
            {
                ...
                if (supportDot - dot < surfaceEpsilon || count > MPRToolbox.InnerIterationLimit) // TODO: Could use a dynamic epsilon for possibly better behavior.
                {
                    ...
                    Fixed64 v1Weight, v2Weight, v3Weight;
                    FixedV3.Multiply(ref direction, t, out position);

                    Toolbox.GetBarycentricCoordinates(ref position, ref v1, ref v2, ref v3, out v1Weight, out v2Weight, out v3Weight);
                    FixedV3.Multiply(ref v1A, v1Weight, out position);
                    FixedV3 temp;
                    FixedV3.Multiply(ref v2A, v2Weight, out temp);
                    FixedV3.Add(ref temp, ref position, out position);
                    FixedV3.Multiply(ref v3A, v3Weight, out temp);
                    FixedV3.Add(ref temp, ref position, out position);
                    ////DEBUG STUFF:
        ...
        static bool VerifySimplex(ref FixedV3 v0, ref FixedV3 v1, ref FixedV3 v2, ref FixedV3 v3, ref FixedV3 direction)
        {


            //v1, v0, v3
            FixedV3 cross = FixedV3.Cross(v0 - v1, v3 - v1);
            Fixed64 planeProduct1 = FixedV3.Dot(cross, direction);
            //v3, v0, v2
            cross = FixedV3.Cross(v0 - v3, v2 - v3);
            Fixed64 planeProduct2 = FixedV3.Dot(cross, direction);
            //v2, v0, v1
            cross = FixedV3.Cross(v0 - v2, v1 - v2);
            Fixed64 planeProduct3 = FixedV3.Dot(cross, direction);
        ...
        public static bool GetContact(ConvexShape shapeA, ConvexShape shapeB, ref RigidTransform transformA, ref RigidTransform transformB, ref FixedV3 penetrationAxis, out ContactData contact)
        {
            RigidTransform localTransformB;
            MinkowskiToolbox.GetLocalTransform(ref transformA, ref transformB, out localTransformB);
            if (MPRToolbox.AreLocalShapesOverlapping(shapeA, shapeB, ref localTransformB))
            {
                ...
                FixedV3 rayCastDirection;
                Fixed64 lengthSquared = penetrationAxis.LengthSquared();
                if (lengthSquared > Toolbox.Epsilon)
                {
                    FixedV3.Divide(ref penetrationAxis, Fixed64.Sqrt(lengthSquared), out rayCastDirection);// (Vector3.Normalize(localDirection) + Vector3.Normalize(collidableB.worldTransform.Position - collidableA.worldTransform.Position)) / 2;
                ...
                FixedV3 normalCandidate;
                Fixed64 depthCandidate;
                lengthSquared = localTransformB.Position.LengthSquared();
                if (lengthSquared > Toolbox.Epsilon)
                {
                    FixedV3.Divide(ref localTransformB.Position, Fixed64.Sqrt(lengthSquared), out rayCastDirection);
                ...
                BEPUMatrix3x3.CreateFromQuaternion(ref transformA.Orientation, out orientation);
                ...
                FixedV3.Add(ref contact.Position, ref transformA.Position, out contact.Position);
                return true;
            }
        ...
        public static void RefinePenetration(ConvexShape shapeA, ConvexShape shapeB, ref RigidTransform localTransformB, Fixed64 initialDepth, ref FixedV3 initialNormal, out Fixed64 penetrationDepth, out FixedV3 refinedNormal, out FixedV3 position)
        {
            //The local casting can optionally continue.  Eventually, it will converge to the local minimum.
        ...
        public static bool Sweep(ConvexShape shapeA, ConvexShape shapeB, ref FixedV3 sweepA, ref FixedV3 sweepB, ref RigidTransform transformA, ref RigidTransform transformB, out RayHit hit)
        {
            //Put the relative velocity into shape's local space.
            FixedV3 velocityWorld;
            //note the order of subtraction.  It 'should' be B-A, but the ray direction the algorithm works with is actually OPPOSITE.
            FixedV3.Subtract(ref sweepA, ref sweepB, out velocityWorld);
            ...
            FixedQuaternion.Transform(ref velocityWorld, ref conjugateOrientationA, out localDirection);
            ...
            Fixed64 rayLengthSquared = localDirection.LengthSquared();
            Fixed64 sweepLength;
            if (rayLengthSquared > Toolbox.Epsilon * F64.C0p01)
            {
                FixedV3.Dot(ref localTransformB.Position, ref localDirection, out sweepLength);
                ...
                sweepLength += (shapeA.MaximumRadius + shapeB.MaximumRadius) / Fixed64.Sqrt(rayLengthSquared);
            }
            else
            {
            ...
            FixedV3 sweep;
            FixedV3.Multiply(ref localDirection, sweepLength, out sweep);
            ...
            if (negativeLength)
            {
                ...
                hit.T = F64.C0;
                FixedV3.Normalize(ref localDirection, out hit.Normal);
                FixedQuaternion.Transform(ref hit.Normal, ref transformA.Orientation, out hit.Normal);
                //hit.Location = hit.T * localDirection;
                FixedQuaternion.Transform(ref hit.Location, ref transformA.Orientation, out hit.Location);
                FixedV3.Add(ref hit.Location, ref transformA.Position, out hit.Location);
            ...
            if (LocalSweepCast(shapeA, shapeB, sweepLength, rayLengthSquared, ref localDirection, ref sweep, ref localTransformB, out hit))
            {
                ...
                FixedV3 minkowskiRayHit = -hit.T * localDirection;
                ...
                FixedV3 temp;
                FixedV3.Multiply(ref sweepA, hit.T, out temp);
                FixedV3.Add(ref temp, ref hit.Location, out hit.Location);
                return true;
            }
            return false;
        ...
        private static bool LocalSweepCast(ConvexShape shape, ConvexShape shapeB, Fixed64 sweepLength, Fixed64 rayLengthSquared, ref FixedV3 localDirection, ref FixedV3 sweep, ref RigidTransform localTransformB, out RayHit hit)
        {
            ...
            //Find another extreme point in a direction perpendicular to the previous.
            FixedV3 v2, v2A;
            FixedV3.Cross(ref localDirection, ref v1, out n);
            hit.Location = new FixedV3();
            if (n.LengthSquared() < Toolbox.Epsilon * F64.C0p01)
            {
                ...
                if (rayLengthSquared > Toolbox.Epsilon * F64.C0p01)
                    FixedV3.Divide(ref localDirection, Fixed64.Sqrt(rayLengthSquared), out hit.Normal);
                else
                    hit.Normal = new FixedV3();

                Fixed64 rate;
                FixedV3.Dot(ref  hit.Normal, ref localDirection, out rate);
                Fixed64 distance;
                FixedV3.Dot(ref  hit.Normal, ref v1, out distance);
                if (rate > F64.C0)
            ...
            //relative to the direction vector.
            Fixed64 dot;
            FixedV3.Dot(ref n, ref localDirection, out dot);
            if (dot > F64.C0)
            {
                //It's not properly calibrated.  Flip the winding (and the previously calculated normal).
                FixedV3.Negate(ref n, out n);
            ...
            while (true)
            {
                ...
                // If the direction is outside the plane defined by v1,v0,v3, then the portal is invalid.
                FixedV3.Cross(ref v1, ref v3, out temp1);
                FixedV3.Dot(ref temp1, ref localDirection, out dot);
                if (dot < F64.C0)
                {
                    //Replace the point that was on the inside of the plane (v2) with the new extreme point.
                    v2 = v3;
            ...
            while (true)
            {
                ...
                if (supportDot - dot < rayCastSurfaceEpsilon || count > MPRToolbox.InnerIterationLimit) // TODO: Could use a dynamic epsilon for possibly better behavior.
                {
                    ...
                    {
                        FixedV3.Divide(ref n, Fixed64.Sqrt(lengthSquared), out hit.Normal);

                        //The plane is very close to the surface, and the ray is known to pass through it.
                        //dot is the rate.
                        FixedV3.Dot(ref  hit.Normal, ref localDirection, out dot);
                        //supportDot is the distance to the plane.
                        FixedV3.Dot(ref  hit.Normal, ref v1, out supportDot);
                ...
                //This v4 x direction is just a minor reordering of a scalar triple product: (v1 x v4) * direction.
                //It eliminates the need for extra cross products for the inner if.
                FixedV3.Cross(ref v4, ref localDirection, out temp1);
                FixedV3.Dot(ref v1, ref temp1, out dot);
                if (dot >= F64.C0)
                {
                    FixedV3.Dot(ref v2, ref temp1, out dot);
        ...
        internal static void GetLocalPosition(ConvexShape shapeA, ConvexShape shapeB, ref RigidTransform localTransformB, ref FixedV3 minkowskiPosition, out FixedV3 position)
        {
            ...
            FixedV3.Add(ref minkowskiPosition, ref localTransformB.Position, out rayDirection);
            ...
            FixedV3 v0;
            FixedV3.Negate(ref localTransformB.Position, out v0); //Since we're in A's local space, A-B is just -B.
            ...
            if (n.LengthSquared() < Toolbox.Epsilon)
            {
                ...
                Fixed64 dot = FixedV3.Dot(v1 - minkowskiPosition, rayDirection);
                ...
                //Origin is inside.
                //Compute barycentric coordinates along simplex (segment).
                Fixed64 dotv0 = FixedV3.Dot(v0 - minkowskiPosition, rayDirection);
                //Dot > 0, so dotv0 starts out negative.
                ...
                FixedV3.Multiply(ref v1A, barycentricCoordinate, out position);
                FixedV3 offset;
                FixedV3.Subtract(ref v1B, ref localTransformB.Position, out offset);
                return;
            }
            MinkowskiToolbox.GetLocalMinkowskiExtremePoint(shapeA, shapeB, ref n, ref localTransformB, out v2A, out v2B, out v2);
            ...
            FixedV3 v0v1, v0v2;
            //Set n for the first iteration.
            FixedV3.Subtract(ref v1, ref v0, out v0v1);
            FixedV3.Subtract(ref v2, ref v0, out v0v2);
            FixedV3.Cross(ref v0v1, ref v0v2, out n);

            FixedV3 pointToV0;
            FixedV3.Subtract(ref v0, ref minkowskiPosition, out pointToV0);
            FixedV3 v3A, v3B, v3;
            int count = 0;
            while (true)
            {
                ...
                FixedV3 v0v3;
                FixedV3.Subtract(ref v1, ref v0, out v0v1);
                FixedV3.Subtract(ref v3, ref v0, out v0v3);
                FixedV3.Cross(ref v0v1, ref v0v3, out temp);
                Fixed64 dot;
                FixedV3.Dot(ref temp, ref pointToV0, out dot);
                if (dot < F64.C0)
                {
                    //Replace the point that was on the inside of the plane (v2) with the new extreme point.
                    v2 = v3;
                    ...
                    v2B = v3B;
                    // Calculate the normal of the plane that will be used to find a new extreme point.
                    FixedV3.Cross(ref v0v1, ref v0v3, out n);
                    continue;
                }

                // If the origin is outside the plane defined by v3,v0,v2, then the portal is invalid.
                FixedV3.Subtract(ref v2, ref v0, out v0v2);
                FixedV3.Cross(ref v0v3, ref v0v2, out temp);
                FixedV3.Dot(ref temp, ref pointToV0, out dot);
                if (dot < F64.C0)
                {
                    //Replace the point that was on the inside of the plane (v1) with the new extreme point.
                    ...
                    v1B = v3B;
                    // Calculate the normal of the plane that will be used to find a new extreme point.
                    FixedV3.Cross(ref v0v2, ref v0v3, out n);
                    continue;
                }
                break;
            }
            ...
            while (true)
            {
                ...
                //Compute the outward facing normal.
                FixedV3 v2v3, v2v1;
                FixedV3.Subtract(ref v3, ref v2, out v2v3);
                FixedV3.Subtract(ref v1, ref v2, out v2v1);
                FixedV3.Cross(ref v2v3, ref v2v1, out n);
                Fixed64 dot;
                FixedV3 pointToV1;
                FixedV3.Subtract(ref v1, ref minkowskiPosition, out pointToV1);
                FixedV3.Dot(ref pointToV1, ref n, out dot);
                ...
                Fixed64 dot2;
                FixedV3 pointToV4;
                FixedV3.Subtract(ref v4, ref minkowskiPosition, out pointToV4);
                FixedV3.Dot(ref pointToV4, ref n, out dot2);
                ...
                if (dot2 - dot < rayCastSurfaceEpsilon || count > MPRToolbox.InnerIterationLimit) // TODO: Could use a dynamic epsilon for possibly better behavior.
                {
                    ...
                    Fixed64 weight1, weight2, weight3;
                    Toolbox.GetBarycentricCoordinates(ref minkowskiPosition, ref v1, ref v2, ref v3, out weight1, out weight2, out weight3);
                    FixedV3.Multiply(ref v1A, weight1, out position);
                    FixedV3.Multiply(ref v2A, weight2, out v2A);
                    FixedV3.Multiply(ref v3A, weight3, out v3A);
                    FixedV3.Add(ref v2A, ref position, out position);
                    FixedV3.Add(ref v3A, ref position, out position);
                ...
                FixedV3.Cross(ref pointToV4, ref pointToV0, out temp);
                FixedV3.Dot(ref pointToV1, ref temp, out dot);
                if (dot >= F64.C0) //Dot v0 x v4 against v1, and dot it against 
                {
                    FixedV3 pointToV2;
                    FixedV3.Subtract(ref v2, ref minkowskiPosition, out pointToV2);
                    FixedV3.Dot(ref pointToV2, ref temp, out dot);
                    if (dot >= F64.C0)
                    {
                        v1 = v4; // Inside v1 & inside v2 ==> eliminate v1
                        v1A = v4A;
                ...
                {
                    FixedV3 pointToV3;
                    FixedV3.Subtract(ref v3, ref minkowskiPosition, out pointToV3);
                    FixedV3.Dot(ref pointToV3, ref temp, out dot);
                    if (dot >= F64.C0)
                    {
                        v2 = v4; // Outside v1 & inside v3 ==> eliminate v2
                        v2A = v4A;
        ...
        public static bool AreSweptShapesIntersecting(ConvexShape shapeA, ConvexShape shapeB, ref FixedV3 sweep, ref RigidTransform localTransformB, out FixedV3 position)
        {
            //It's possible that the two objects' centers are overlapping, or very very close to it.  In this case, 
            //they are obviously colliding and we can immediately exit.
            ...
            //This implementation is similar to that of the original XenoCollide.
            //'n' will be the direction used to find supports throughout the algorithm.
            FixedV3 n = localTransformB.Position;
            FixedV3 v1;
            FixedV3 v1A; //extreme point contributions from each shape.  Used later to compute contact position; could be used to cache simplex too.
            ...
            if (n.LengthSquared() < Toolbox.Epsilon)
            {
                ...
                //If the origin is within this extreme point, then there is an intersection.
                Fixed64 dot;
                FixedV3.Dot(ref v1, ref localTransformB.Position, out dot);
                if (dot < F64.C0)
                {
                    //Origin is outside.
                    position = new FixedV3();
                ...
                Fixed64 dotv0;
                //Dot > 0, so dotv0 starts out negative.
                FixedV3.Dot(ref v0, ref localTransformB.Position, out dotv0);
                Fixed64 barycentricCoordinate = -dotv0 / (dot - dotv0);
                //Vector3.Subtract(ref v1A, ref v0A, out offset); //'v0a' is just the zero vector, so there's no need to calculate the offset.
                FixedV3.Multiply(ref v1A, barycentricCoordinate, out position);
                return true;
            ...
            while (true)
            {
                ...
                if (dot >= F64.C0)
                {
                    ...
                    FixedV3.Cross(ref localTransformB.Position, ref temp2, out cross);
                    Fixed64 v0ov2v3volume;
                    FixedV3.Dot(ref cross, ref temp3, out v0ov2v3volume);

                    FixedV3.Cross(ref temp1, ref localTransformB.Position, out cross);
                    Fixed64 v0v1ov3volume;
                    FixedV3.Dot(ref cross, ref temp3, out v0v1ov3volume);
        ...
        static void GetSweptExtremePoint(ConvexShape shapeA, ConvexShape shapeB, ref RigidTransform localTransformB, ref FixedV3 sweep, ref FixedV3 extremePointDirection, out FixedV3 extremePointA, out FixedV3 extremePoint)
        {
            FixedV3 b;
            ...
            Fixed64 dot;
            FixedV3.Dot(ref extremePointDirection, ref sweep, out dot);
            if (dot > F64.C0)
            {
                FixedV3.Add(ref extremePoint, ref sweep, out extremePoint);
            }
        }
        ...
        /// <returns>Whether or not the swept shapes hit each other.</returns>
        public static bool RayCast(BEPURay ray, Fixed64 maximumLength, ConvexShape shape, ref RigidTransform transform, out RayHit hit)
        {
            ...
            FixedV3.Negate(ref localRay.Direction, out localRay.Direction);
            ...
            if (Toolbox.RayCastSphere(ref ray, ref transform.Position, shape.MaximumRadius, maximumLength, out sphereHit))
            {
                ...
                FixedV3 offset;
                FixedV3.Multiply(ref localRay.Direction, -sphereHit.T, out offset);
                FixedV3.Add(ref localRay.Position, ref offset, out localRay.Position);
            }
            else
            {
            ...
            Fixed64 rayLengthSquared = localRay.Direction.LengthSquared();
            Fixed64 sweepLength;
            if (rayLengthSquared > Toolbox.Epsilon * F64.C0p01)
            {
                FixedV3.Dot(ref localRay.Position, ref localRay.Direction, out sweepLength);
                //Ray length isn't necessarily normalized...
                sweepLength /= rayLengthSquared;
                //Scale the sweep length by the margins.  Divide by the length to pull the margin into terms of the length of the ray.
                sweepLength += shape.MaximumRadius / Fixed64.Sqrt(rayLengthSquared);
            }
            else
            {
                rayLengthSquared = F64.C0;
            ...
            FixedV3 sweep;
            FixedV3.Multiply(ref localRay.Direction, sweepLength, out sweep);
            //Check to see if the origin is contained within the swept shape.
            ...
            if (negativeLength)
            {
                ...
                hit.T = F64.C0;
                FixedV3.Normalize(ref ray.Direction, out hit.Normal);
        ...
        public static bool SweptShapeContainsPoint(ConvexShape shape, ref FixedV3 sweep, ref FixedV3 localPoint)
        {
            //It's possible that the two objects' centers are overlapping, or very very close to it.  In this case, 
            //they are obviously colliding and we can immediately exit.
            ...
            FixedV3 v0;
            FixedV3.Negate(ref localPoint, out v0); //Since we're in A's local space, A-B is just -B.
            ...
            if (n.LengthSquared() < Toolbox.Epsilon)
            {
                ...
                //If the origin is within this extreme point, then there is an intersection.
                Fixed64 dot;
                FixedV3.Dot(ref v1, ref localPoint, out dot);
                if (dot < F64.C0)
                {
                    //Origin is outside.
                    return false;
        ...
        private static bool LocalSweepCast(ConvexShape shape, Fixed64 sweepLength, Fixed64 rayLengthSquared, ref FixedV3 localDirection, ref FixedV3 sweep, ref FixedV3 rayOrigin, out RayHit hit)
        {
            //By now, the ray is known to be within the swept shape and facing the right direction for a normal raycast.
        ...
        static void GetSweptExtremePoint(ConvexShape shape, ref FixedV3 point, ref FixedV3 sweep, ref FixedV3 extremePointDirection, out FixedV3 extremePoint)
        {
            shape.GetExtremePoint(extremePointDirection, ref Toolbox.RigidIdentity, out extremePoint);
            FixedV3.Subtract(ref extremePoint, ref point, out extremePoint);
            Fixed64 dot;
            FixedV3.Dot(ref extremePointDirection, ref sweep, out dot);
            if (dot > F64.C0)
            {
