...
namespace BEPUPhysics1int.Paths
{
    ...
    /// </summary>
    public class StepCurve1D : Curve<Fixed64>
    {
        /// <summary>
        ...
        public override void Evaluate(int controlPointIndex, Fixed64 weight, out Fixed64 value)
        {
        ...
        protected internal override void ControlPointAdded(CurveControlPoint<Fixed64> curveControlPoint, int index)
        {
        }

        protected internal override void ControlPointRemoved(CurveControlPoint<Fixed64> curveControlPoint, int oldIndex)
        {
        }

        protected internal override void ControlPointTimeChanged(CurveControlPoint<Fixed64> curveControlPoint, int oldIndex, int newIndex)
        {
        }

        protected internal override void ControlPointValueChanged(CurveControlPoint<Fixed64> curveControlPoint)
        {
        }
    }
}