...
namespace BEPUphysics.DeactivationManagement
{
    ...
    public class DeactivationManager : MultithreadedProcessingStage
    {
        ...
        internal Fixed64 velocityLowerLimit = (Fixed64).26m;
        internal Fixed64 velocityLowerLimitSquared = (Fixed64)(.26m * .26m);
        internal Fixed64 lowVelocityTimeMinimum = F64.C1;
        ...
        /// Defaults to 0.26.
        ///</summary>
        public Fixed64 VelocityLowerLimit
        {
            get
            {
        ...
        /// Defaults to 1.
        /// </summary>
        public Fixed64 LowVelocityTimeMinimum
        {
            get
            {
        ...
        static Fixed64 maximumSplitAttemptsFraction = (Fixed64).01m;
        /// <summary>
        ...
        /// Defaults to .04f.
        /// </summary>
        public static Fixed64 MaximumSplitAttemptsFraction
        {
            get
            {
        ...
        void FlushSplits()
        {
            ...
            int maxAttempts = Math.Max(minimumSplitAttempts, (int)((Fixed64)splitAttempts.Count * maximumSplitAttemptsFraction));
            int attempts = 0;
