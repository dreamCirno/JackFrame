...
namespace BEPUik
{
    ...
    public class ActiveSet : IDisposable
    {
        ...
        private Fixed64 automassUnstressedFalloff = (Fixed64)0.9m;
        /// <summary>
        ...
        /// </summary>
        public Fixed64 AutomassUnstressedFalloff
        {
        ...
        void DistributeMass(Bone bone)
        {
            ...
            Fixed64 massPerChild = uniqueChildren.Count > 0 ? automassUnstressedFalloff * bone.Mass / uniqueChildren.Count : F64.C0;
        ...
        void DistributeMass(List<Control> controls)
        {
            ...
            Fixed64 lowestInverseMass = Fixed64.MaxValue;
            foreach (var bone in bones)
            {
            ...
            Fixed64 inverseMassScale = F64.C1 / (AutomassTarget * lowestInverseMass);
