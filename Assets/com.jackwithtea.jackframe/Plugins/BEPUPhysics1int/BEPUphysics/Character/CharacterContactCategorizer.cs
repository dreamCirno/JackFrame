...
namespace BEPUPhysics1int.Character
{
    ...
    {
        private Fixed64 tractionThreshold;
        private Fixed64 supportThreshold;
        private Fixed64 headThreshold;
        /// <summary>
        ...
        /// </summary>
        public Fixed64 TractionThreshold
        {
        ...
        /// </summary>
        public Fixed64 SupportThreshold
        {
        ...
        /// </summary>
        public Fixed64 MaximumTractionSlope
        {
            get { return Fixed64.Acos(TractionThreshold); }
            set { TractionThreshold = Fixed64.Cos(value); }
        }
        /// <summary>
        /// Gets or sets the maximum slope that a character can be supported by.
        /// </summary>
        public Fixed64 MaximumSupportSlope
        {
            get { return Fixed64.Acos(SupportThreshold); }
            set { SupportThreshold = Fixed64.Cos(value); }
        }
		...
		public CharacterContactCategorizer(Fixed64 maximumTractionSlope, Fixed64 maximumSupportSlope)
		{
			MaximumTractionSlope = maximumTractionSlope;
			MaximumSupportSlope = maximumSupportSlope;
			HeadThreshold = (Fixed64)(-.01m);
		...
		/// A value near -1 implies that the contact will only be considered a 'head' contact when the support normal is almost aligned with the character's vertical axis.
		/// A value near -epsilon implies that almost all upper contacts will be considered head contacts.</param>
		public CharacterContactCategorizer(Fixed64 maximumTractionSlope, Fixed64 maximumSupportSlope, Fixed64 headThreshold)
        {
            MaximumTractionSlope = maximumTractionSlope;
            MaximumSupportSlope = maximumSupportSlope;
        ...
        public void CategorizeContacts<TOutputContacts>(CollidablePairHandler pair, EntityCollidable characterCollidable, ref FixedV3 downDirection, 
                                                            ...
                                                            where TOutputContacts : IList<CharacterContact>
        {
            ...
            for (int i = pair.ContactCount - 1; i >= 0; --i)
            {
                ...
                Fixed64 dot;
                FixedV3 offset;
                FixedV3.Subtract(ref characterContact.Contact.Position, ref characterCollidable.worldTransform.Position, out offset);
                FixedV3.Dot(ref characterContact.Contact.Normal, ref offset, out dot);
                if (dot < F64.C0)
                {
                    //The normal should face outward.
                    FixedV3.Negate(ref characterContact.Contact.Normal, out characterContact.Contact.Normal);
                }

                FixedV3.Dot(ref characterContact.Contact.Normal, ref downDirection, out dot);
