...
namespace BEPUPhysics1int.Character
{
    ...
    public class HorizontalMotionConstraint : SolverUpdateable
    {
        ...
        /// </summary>
        public Fixed64 MaximumAccelerationForce { get; set; }
        Fixed64 maxForceDt;
        Fixed64 maxAccelerationForceDt;

        private Fixed64 timeUntilPositionAnchor = (Fixed64).2m;
        ...
        /// </summary>
        public Fixed64 TimeUntilPositionAnchor
        {
        ...
        /// </summary>
        public Fixed64 PositionAnchorDistanceThreshold { get; set; }
        ...
        public HorizontalMotionConstraint(Entity characterBody, SupportFinder supportFinder)
        {
            ...
            MaximumAccelerationForce = Fixed64.MaxValue;
        }
