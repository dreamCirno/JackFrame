...
namespace BEPUPhysics1int.Paths
{
    ...
    public abstract class VariableSpeedCurve<TValue> : SpeedControlledCurve<TValue>
    {
        ...
        protected VariableSpeedCurve(Path<Fixed64> speedCurve, Curve<TValue> curve)
            : base(curve)
        {
        ...
        protected VariableSpeedCurve(Path<Fixed64> speedCurve, Curve<TValue> curve, int sampleCount)
        ...
        /// </summary>
        public Path<Fixed64> SpeedCurve { get; set; }
        ...
        public override Fixed64 GetSpeedAtCurveTime(Fixed64 time)
        {
