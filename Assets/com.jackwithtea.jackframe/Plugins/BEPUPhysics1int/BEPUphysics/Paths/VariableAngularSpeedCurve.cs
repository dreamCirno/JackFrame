...
namespace BEPUphysics.Paths
{
    ...
    public class VariableAngularSpeedCurve : VariableSpeedCurve<Quaternion>
    {
        ...
        public VariableAngularSpeedCurve(Path<Fixed64> speedCurve, Curve<Quaternion> curve)
        ...
        public VariableAngularSpeedCurve(Path<Fixed64> speedCurve, Curve<Quaternion> curve, int sampleCount)
