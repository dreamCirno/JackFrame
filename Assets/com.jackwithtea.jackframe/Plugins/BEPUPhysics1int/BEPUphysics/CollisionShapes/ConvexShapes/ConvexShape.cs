...
namespace BEPUPhysics1int.CollisionShapes.ConvexShapes
{
    ...
    public abstract class ConvexShape : EntityShape
    {
        ...
        protected internal Fixed64 collisionMargin = CollisionDetectionSettings.DefaultMargin;
        ///<summary>
        ...
        ///</summary>
        public Fixed64 CollisionMargin
        {
            get
            {
        ...
        /// </summary>
        public Fixed64 MinimumRadius { get; internal set; }
        ...
        /// </summary>
        public Fixed64 MaximumRadius { get; internal set; }
        ...
        public abstract void GetLocalExtremePointWithoutMargin(ref FixedV3 direction, out FixedV3 extremePoint);
        ...
        ///<param name="extremePoint">Extreme point on the shape.</param>
        public void GetExtremePointWithoutMargin(FixedV3 direction, ref RigidTransform shapeTransform, out FixedV3 extremePoint)
        {
            FixedQuaternion conjugate;
            FixedQuaternion.Conjugate(ref shapeTransform.Orientation, out conjugate);
            FixedQuaternion.Transform(ref direction, ref conjugate, out direction);
            GetLocalExtremePointWithoutMargin(ref direction, out extremePoint);

            FixedQuaternion.Transform(ref extremePoint, ref shapeTransform.Orientation, out extremePoint);
            FixedV3.Add(ref extremePoint, ref shapeTransform.Position, out extremePoint);
        }
        ...
        /// <param name="shapeTransform">Transform to use for the shape.</param>
        ///<param name="extremePoint">Extreme point on the shape.</param>
        public void GetExtremePoint(FixedV3 direction, ref RigidTransform shapeTransform, out FixedV3 extremePoint)
        {
            GetExtremePointWithoutMargin(direction, ref shapeTransform, out extremePoint);

			Fixed64 directionLength = direction.LengthSquared();
            if (directionLength > Toolbox.Epsilon)
            {
                FixedV3.Multiply(ref direction, collisionMargin / Fixed64.Sqrt(directionLength), out direction);
                FixedV3.Add(ref extremePoint, ref direction, out extremePoint);
            }
        ...
        ///<param name="direction">Direction to find the extreme point in.</param>
        ///<param name="extremePoint">Extreme point on the shape.</param>
        public void GetLocalExtremePoint(FixedV3 direction, out FixedV3 extremePoint)
        {
            GetLocalExtremePointWithoutMargin(ref direction, out extremePoint);
        ...
        public override void GetBoundingBox(ref RigidTransform shapeTransform, out BoundingBox boundingBox)
        {
            ...
            FixedV3 right;
            var direction = new FixedV3(o.M11, o.M21, o.M31);
            GetLocalExtremePointWithoutMargin(ref direction, out right);

            FixedV3 left;
            direction = new FixedV3(-o.M11, -o.M21, -o.M31);
            GetLocalExtremePointWithoutMargin(ref direction, out left);

            FixedV3 up;
            direction = new FixedV3(o.M12, o.M22, o.M32);
            ...
            FixedV3 backward;
            direction = new FixedV3(o.M13, o.M23, o.M33);
        ...
        public virtual bool RayTest(ref BEPURay ray, ref RigidTransform transform, Fixed64 maximumLength, out RayHit hit)
        {
        ...
        public void GetSweptBoundingBox(ref RigidTransform transform, ref FixedV3 sweep, out BoundingBox boundingBox)
        {
        ...
        public void GetLocalBoundingBox(ref RigidTransform shapeTransform, ref AffineTransform spaceTransform, out BoundingBox boundingBox)
        {
            ...
            FixedV3 right;
            var direction = new FixedV3(transform.LinearTransform.M11, transform.LinearTransform.M21, transform.LinearTransform.M31);
            GetLocalExtremePoint(direction, out right);

            FixedV3 left;
            direction = new FixedV3(-transform.LinearTransform.M11, -transform.LinearTransform.M21, -transform.LinearTransform.M31);
            GetLocalExtremePoint(direction, out left);

            FixedV3 up;
            direction = new FixedV3(transform.LinearTransform.M12, transform.LinearTransform.M22, transform.LinearTransform.M32);
            ...
            FixedV3 backward;
            direction = new FixedV3(transform.LinearTransform.M13, transform.LinearTransform.M23, transform.LinearTransform.M33);
