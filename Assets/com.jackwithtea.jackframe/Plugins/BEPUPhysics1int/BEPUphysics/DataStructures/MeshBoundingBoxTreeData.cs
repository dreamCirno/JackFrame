...
namespace BEPUPhysics1int.DataStructures
{
    ...
    public abstract class MeshBoundingBoxTreeData
    {
        ...
        internal FixedV3[] vertices;
        ///<summary>
        /// Gets or sets the vertices of the triangle mesh.
        ///</summary>
        public FixedV3[] Vertices
        {
            get
            {
                return vertices;
        ...
        public void GetBoundingBox(int triangleIndex, out BoundingBox boundingBox)
        {
            ...
            FixedV3.Min(ref v1, ref v2, out boundingBox.Min);
            FixedV3.Min(ref boundingBox.Min, ref v3, out boundingBox.Min);
            FixedV3.Max(ref v1, ref v2, out boundingBox.Max);
            FixedV3.Max(ref boundingBox.Max, ref v3, out boundingBox.Max);
        ...
        public abstract void GetTriangle(int triangleIndex, out FixedV3 v1, out FixedV3 v2, out FixedV3 v3);
        ///<summary>
        ...
        public abstract void GetVertexPosition(int i, out FixedV3 vertex);
    }
}
