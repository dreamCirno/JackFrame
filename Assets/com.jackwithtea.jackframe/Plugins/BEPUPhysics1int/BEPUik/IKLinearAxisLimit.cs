...
namespace BEPUik
{
    ...
    public class IKLinearAxisLimit : IKLimit
    {
        ...
        public IKLinearAxisLimit(Bone connectionA, Bone connectionB, FixedV3 lineAnchor, FixedV3 lineDirection, FixedV3 anchorB, Fixed64 minimumDistance, Fixed64 maximumDistance)
        ...
        protected internal override void UpdateJacobiansAndVelocityBias()
        {
            ...
            FixedQuaternion.Transform(ref LocalLineAnchor, ref ConnectionA.Orientation, out offsetA);
            ...
            else if (currentDistance < minimumDistance)
            {
                ...
                FixedV3.Negate(ref lineDirection, out lineDirection);
            }
